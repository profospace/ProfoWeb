    ...
    return (
        <div className="relative bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="relative h-[240px] overflow-hidden">
                <img
                    src={property.image || '/assets/testing.avif'}
            ...
            <div className="p-4">
                ...
                <div className="mb-3">
                    <h3 className="text-2xl font-bold text-gray-900">${property.price.toLocaleString()|| '50000'}</h3>
                </div>

                <div className="flex items-center gap-4 mb-3">
                    <div className="flex items-center gap-1">
                        <span className="font-bold text-gray-900">{property.beds || '2'}</span>
                        <span className="text-gray-600">bed</span>
                    </div>
                    <div className="flex items-center gap-1">
                        <span className="font-bold text-gray-900">{property.baths || '3'}</span>
                        <span className="text-gray-600">bath</span>
                    </div>
                    <div className="flex items-center gap-1">
                        <span className="font-bold text-gray-900">{property.sqft.toLocaleString() || '2500'}</span>
