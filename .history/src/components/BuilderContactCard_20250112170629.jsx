...
const BuilderContactCard = ({ propertyDetail }) => {
    ...
    return (
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl border-1 py-8 px-10 my-12">
            {/* Header Section */}
            ...
            {/* Contact Section */}
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-3 md:space-y-0 md:space-x-4 bg-gray-50 py-6 px-4 rounded-md ">
                <div className="flex items-center space-x-2">
                    <p className="text-2xl font-bold">{propertyDetail?.builder?.contacts?.[0]}</p>
                </div>
                <div className="flex items-center space-x-2">
            ...
            {/* Property Card */}
            <div className="flex flex-col items-center md:flex-row space-y-1 md:space-y-0 md:space-x-6">
