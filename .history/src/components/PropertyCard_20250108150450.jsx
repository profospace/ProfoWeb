        ...
        <div className="relative bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="relative h-[240px] overflow-hidden">
                ...
                <div className="absolute top-3 left-3 flex gap-1">
                    <span className="bg-blue-600 text-white px-4 py-[0.5px] rounded-full text-sm font-medium">
                        {/* New - {property.timePosted || '8 hours ago'} */}
                        {property?.tags[0] || "Super"}
                    </span>
                    <span className="bg-orange-600 text-white px-4 py-[0.5px] rounded-full text-sm font-medium">
                        {/* New - {property.timePosted || '8 hours ago'} */}
                        {property?.tags[1] || "Star"}
                    </span>
                </div>
