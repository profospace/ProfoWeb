...
const BuilderContactCard = ({ propertyDetail , isPopupVisible }) => {
    // Format price to include spaces between thousands
    const formatPrice = (price) => {
        return price?.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    };
    ...
    return (
        { isPopupVisible && <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-xl border-1 py-8 px-10 my-10">
            {/* Header Section */}
