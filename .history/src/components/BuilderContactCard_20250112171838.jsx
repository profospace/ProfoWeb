...
const BuilderContactCard = ({ propertyDetail }) => {
    ...
    return (
        <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-xl border-1 py-8 px-10 my-10">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-3 md:space-y-0 md:space-x-4 bg-gray-50 py-2 px-4 rounded-md">
                <div className="flex fle items-center space-x-2">
                    <p className="text-2xl font-bold">{propertyDetail?.builder?.contacts?.[0]}</p>
                    <p className="text-xs font-bold">anuragsonkar053@gmail.com</p>
                    <p className="text-xs font-bold">anuragsonkar053@gmail.com</p>
                </div>
                <div className="flex items-center space-x-2">
                    <QRCode
