        ...
        <div className="relative bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="p-4">
                ...
                <div className='grid grid-cols-4 gap-2 items-center'>
                    <button className="col-span-3 w-full py-2.5 px-4 border-2 border-gray-900 rounded-full text-gray-900 font-medium hover:bg-gray-900 hover:text-white transition-colors flex items-center justify-center gap-2">
                        <Mail className="w-4 h-4" />
                        Email Agent
                    </button>
                    <button className="w-full rounded-full border-2 border-gray-900 rounded-full text-gray-900 font-medium hover:bg-gray-900 hover:text-white transition-colors flex items-center justify-center gap-2">
                        {/* <Mail className="w-4 h-4" /> */}
